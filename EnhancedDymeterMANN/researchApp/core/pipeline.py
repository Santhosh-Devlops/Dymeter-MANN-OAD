...
class ResearchPipeline:
    ...
    def runFile(self, datasetPath: str | Path, modelName: str = "EnhancedDymeterMANN", config: dict | None = None) -> RunBundle:
    ...
    def validateModelName(self, modelName: str) -> None:
        if modelName == "EnhancedDymeterMANN":
            return
        raise ValueError("This folder is scoped to EnhancedDymeterMANN. Use model EnhancedDymeterMANN.")
